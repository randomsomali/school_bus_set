...
const char* serverURL = "http://192.168.100.75:6100/api/esp32/fingerprint/poll";
const char* attendanceURL = "http://192.168.100.75:6100/api/esp32/fingerprint/attendance";
...
void lcdPrintMultiLine(const char *line1, const char *line2 = nullptr) {
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print(line1);
  if (line2 != nullptr) {
